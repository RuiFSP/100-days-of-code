...
def seed_db():
    with app.app_context():
        ...
        products = [
            Product(name='Sample Product 1', price=100, image='static/images/product1.jpg'),
            Product(name='Sample Product 2', price=200, image='static/images/product2.jpg'),
            Product(name='Sample Product 3', price=300, image='static/images/product3.jpg')
        ]
